...
public class DevLingoLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "T__20", "T__21", "DIGITS", "BOOLEAN", "ADDITIONAL", 
			"SUBTRACT", "MULTIPLY", "DIVISION", "AND", "OR", "LESS_THAN", "GREATER_THAN", 
			"LESS_THAN_OR_EQUAL", "GREATER_THAN_OR_EQUAL", "NOT_EQUAL_TO", "IS_EQUAL_TO", 
			"IDEN", "STRING", "EQUALS", "WHITE_SPACES"
		};
	}
	...
	public DevLingoLexer(CharStream input) {
		super(input);
